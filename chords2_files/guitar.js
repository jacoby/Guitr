...
function draw_dots(ctx, aFret, aString) {
  ...
  if (i01.checked == true) {
    interval.push(parseInt(1));
  }
  if (i02.checked == true) {
    interval.push(parseInt(2));
  }
  if (i03.checked == true) {
    interval.push(parseInt(3));
  }
  if (i04.checked == true) {
    interval.push(parseInt(4));
  }
  if (i05.checked == true) {
    interval.push(parseInt(5));
  }
  if (i06.checked == true) {
    interval.push(parseInt(6));
  }
  if (i07.checked == true) {
    interval.push(parseInt(7));
  }
  if (i08.checked == true) {
    interval.push(parseInt(8));
  }
  if (i09.checked == true) {
    interval.push(parseInt(9));
  }
  if (i10.checked == true) {
    interval.push(parseInt(10));
  }
  if (i11.checked == true) {
